          ...
          <div class="card-body">
           <div class="pricetext">
            ...
            <span class="price text-muted float-right">${{$product->spl_price}}</span>
             ...
             <a href="{{url('/product_details')}}/<?php echo $product->id; ?>" class="btn btn-primary btn-sm">View Product</a>
            
             <a href="{{url('/cart/addItem')}}/<?php echo $product->id; ?>" class="btn btn-primary btn-sm float-right">Add ToCart<i class="fa fa-shopping-cart"></i></a>
            </div>
          </div>
          @empty
            <h3>No Products</h3>
